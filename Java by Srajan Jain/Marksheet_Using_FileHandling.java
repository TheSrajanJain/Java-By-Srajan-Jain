...
public class Marksheet_Using_FileHandling {
    public static void main(String[] args) {
        ...
        System.out.println("Your MarkSheet Generated, Check Marksheet.txt");
        try {
            FileWriter writer = new FileWriter("Marksheet.txt", true);
            writer.write("=============== Indian Institute Of Technology ===============\n");
            ...
            if(Stream.equals("PCM")){
                writer.write("Marks in Physics       : " + phy + "\n");
                writer.write("Marks in Chemistry     : " + chem + "\n");
                writer.write("Marks in Mathematics   : " + maths + "\n");
            }
            else if(Stream.equals("PCB")){
                writer.write("Marks in Physics       : " + phy + "\n");
                writer.write("Marks in Chemistry     : " + chem + "\n");
                writer.write("Marks in Biology       : " + bio + "\n");
            }
            else if(Stream.equals("Arts")){
                writer.write("Marks in Social Studies: " + sst + "\n");
                writer.write("Marks in English       : " + eng + "\n");
                writer.write("Marks in History       : " + history + "\n");
            }
            else if(Stream.equals("Commerce")){
                writer.write("Marks in Accountancy   : " + accountancy + "\n");
                writer.write("Marks in Business Studies: " + business_studies + "\n");
                writer.write("Marks in Economics     : " + economics + "\n");
            }
            writer.write("Total Marks       : " + total + "\n");
            writer.write("Percentage        : " + percent + "%\n");
            writer.write("Result            : " + (percent >= 35 ? "Pass" : "Fail") + "\n");
            writer.write("----------------------------------------\n\n");
            writer.close();
            System.out.println("Marksheet saved successfully to file!");
        }
        catch (IOException e) {
            System.out.println("Error saving Marksheet to file.");
            e.printStackTrace();
        }
    }
}
